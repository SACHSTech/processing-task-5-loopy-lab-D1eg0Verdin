...
*/
  ...
  public void draw_section5(){
    ...
    int counterRow = 0;
    int counterColumn = 0;
    for(int column = 30; column > counterColumn; column--){
      for(int row = 30; row > counterRow; row--){
        intX = 3 - 10 + row* 300 / 30;
        intY = 3 + column * 300 / 30;
  ...
  public void draw_section6(){
    ...
    int counterColumn = 0;
    for(int column = 30; column > counterColumn; column--){
      for(int row = 0; row < counterRow; row++){
        intX = 3 + 300 + row * 300 / 30;
        intY = 3 - 10 + column * 300 / 30;
  ...
  public void draw_section7(){
    ...
    for(int column = 0; column < counterColumn; column++){
      for(int row = 0; row < counterRow; row++){
        intX = 3 + 600 + row * 300 / 30;
        intY = 3  + column * 300 / 30;
